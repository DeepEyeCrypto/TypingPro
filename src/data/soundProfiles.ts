...
export const SOUND_PROFILES: SoundProfile[] = [
    ...
    { id: 'mechanical', name: 'Mechanical (Blue)', type: 'file', path: '/sounds/mechanical.mp3', volume: 1.0 },
    { id: 'creamy', name: 'Minimalist (Cream)', type: 'file', path: '/sounds/creamy.mp3', volume: 1.0 },
    { id: 'pop', name: 'Bubble (Pop)', type: 'file', path: '/sounds/pop.mp3', volume: 0.8 },
    { id: 'click', name: 'Click', type: 'synth', volume: 1.0, detune: true },
    { id: 'beep', name: 'Beep', type: 'synth', volume: 0.8 },
    { id: 'typewriter', name: 'Typewriter', type: 'file', path: '/sounds/typewriter.mp3', volume: 1.2 },
