...
export const AchievementToast: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[9999] animate-bounce-in">
            <div className="bg-white/10 border border-white/20 backdrop-blur-xl rounded-2xl p-4 flex items-center gap-4 shadow-[0_0_30px_rgba(0,0,0,0.5)] min-w-[360px]">
                <div className="w-12 h-12 rounded-xl bg-black/5 flex items-center justify-center text-2xl border border-black/10">
                    {active.icon || '🏆'}
                </div>
                <div className="flex-1">
                    ...
                    <p className="text-white font-bold text-sm opacity-60">{active.message}</p>
                    {active.reward && (
                        <div className="mt-1 flex items-center gap-1 text-white text-xs font-black">
                ...
                <div className="flex items-center gap-2">
                    {active.onAction && (
                        <button
                            ...
                            className="px-3 py-1.5 bg-black/5 text-white text-[10px] font-black uppercase rounded-lg hover:bg-white/10 transition-all border border-black/10"
                        >
                    ...
                    <button
                        ...
                        className="text-white opacity-20 hover:opacity-100 transition-opacity p-1"
                    >
