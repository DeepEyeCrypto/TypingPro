...
export const AuthButtons = () => {
  ...
  const handleLogin = async (provider: 'google' | 'github') => {
    try {
      ...
      // 4. Wait for Code
      // plugin-oauth start() returns a promise that resolves with the code (or redirect URL params)
      // when the redirect hits the listener.
    ...
    <div className="auth-buttons">
      ...
      <style>{`
        ...
        .auth-btn {
          ...
          color: #646669; /* Monkeytype subtle gray */
          position: relative;
          z-index: 9999;
