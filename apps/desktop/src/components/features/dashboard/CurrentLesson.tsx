...
export const CurrentLesson: React.FC<CurrentLessonProps> = ({
    ...
    return (
        <div className="glass-panel rounded-2xl lg:rounded-[3rem] p-6 lg:p-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-8 hover:bg-white/10 transition-all shadow-xl group text-white">
