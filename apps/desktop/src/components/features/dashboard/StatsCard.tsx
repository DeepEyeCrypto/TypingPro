    ...
    return (
        <GlassCard className={`p-6 lg:p-8 group hover:translate-y-[-4px] transition-all duration-500 ${className}`}>
            <div className="flex justify-between items-start mb-4 lg:mb-6">
                <div className="w-10 h-10 lg:w-12 lg:h-12 glass-panel rounded-xl lg:rounded-2xl flex items-center justify-center text-xl lg:text-2xl shadow-lg">
                    {icon}
                </div>

                {/* Stage 3: Glass Pill (Tag) */}
                <div className="px-2 lg:px-3 py-1 glass-panel rounded-full shadow-sm">
            ...
            <div className="mt-6 lg:mt-8 pt-4 lg:pt-6 border-t border-white/10">
                <div className="inline-flex items-center gap-2 px-3 lg:px-4 py-1.5 lg:py-2 glass-panel rounded-full hover:bg-[var(--text-accent)] hover:text-white transition-all cursor-pointer shadow-sm group/btn">
