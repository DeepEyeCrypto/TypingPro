...
export const SmartDrillCard: React.FC<SmartDrillCardProps> = ({ onStart }) => {
    return (
        <div className="glass-panel rounded-3xl p-6 h-full flex flex-col justify-between group cursor-pointer hover:bg-white/10 hover:border-white/20 transition-all hover:translate-y-[-2px] shadow-[0_8px_32px_rgba(0,0,0,0.05),inset_0_1px_0_0_rgba(255,255,255,0.1)] relative overflow-hidden text-white">
            {/* Background Glow */}
