...
export const ProfileSidebar: React.FC<ProfileSidebarProps> = ({
    ...
    return (
        <div className="space-y-8 pr-2">
            {/* Profile Card */}
            <div className="glass-panel rounded-[3rem] p-8 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] relative overflow-hidden group">
            ...
            {/* Daily Challenges */}
            <div className="glass-panel rounded-[3rem] p-8 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)]">
                <div className="flex justify-between items-center mb-6">
