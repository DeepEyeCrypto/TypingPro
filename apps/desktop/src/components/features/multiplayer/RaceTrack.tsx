        ...
        <div className="w-full space-y-4 py-6">
            {players.map((player) => (
                <div key={player.id} className="relative w-full">
                    {/* Track Base */}
                    <div className="w-full h-8 glass-panel rounded-full overflow-hidden relative">
                        ...
                        >
                            ...
                            {/* Player Name Tooltip */}
                            <div className="absolute -top-8 whitespace-nowrap text-xs font-bold text-white/80 glass-panel bg-black/50 px-2 py-1 rounded">
