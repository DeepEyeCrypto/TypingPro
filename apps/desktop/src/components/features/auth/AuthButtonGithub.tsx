...
export const AuthButtonGithub = () => {
    const login = async () => {
        const url = await invoke<string>('github_auth_start')
        window.location.href = url
    }

    return (
        <button onClick={login} className="auth-btn github">
            <svg width="14" height="14" viewBox="0 0 24 24" className="fill-gray-900 dark:fill-white">
