...
import { startSession, handleKeystroke, TypingMetrics } from '../lib/tauri'
...
import { checkBadgeEligibility } from '../core/badgeService'
import { updateStreak } from '../core/streakService'
import { userService } from '../core/userService'
import { generateDailyChallenges, updateChallengeProgress } from '../core/challengeService'
...
export const useTyping = () => {
    ...
    const handleResult = useCallback(async () => {
        ...
        if (currentUser && metrics.raw_wpm > 10) {
            ...
            import('../core/userService').then(({ userService }) => {
